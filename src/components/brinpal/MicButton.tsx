        ...
        {showInput ? (
          ...
          >
            <motion.button
              ...
              className="relative w-[50px] h-[50px] rounded-full bg-gradient-to-br from-cyan to-gold flex items-center justify-center mic-pulse"
              aria-label="Activar micrófono"
            >
              <span className="absolute inset-0 rounded-full border border-cyan/40 animate-ping opacity-30" />
              <Mic className="w-[22px] h-[22px] text-primary-foreground relative z-10" />
            </motion.button>
